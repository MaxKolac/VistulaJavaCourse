...
public class Pigeon extends Bird implements AnimalMove, AnimalBehavior{
    ...
    public void sleep(){ System.out.println("The pigeon is sleeping in its nest, dreaming about pooping on an expensive Lamborghini"); }
    public void move(){ System.out.println("The pigeon is flying through the air"); }
}
